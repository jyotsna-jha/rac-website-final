...
const OurHistory = () => {
  return (
    <section className="py-6 md:py-16">
      <div className="max-w-screen-lg mx-auto flex flex-col items-center p-4 md:p-0">
        <h2 className="text-xl md:text-3xl font-bold text-black mb-4 relative after:content-[''] after:w-1/2 after:h-[2px] after:bg-orange-300 after:absolute after:bottom-0 after:left-0">
          Our History
        </h2>
        <p className="text-sm md:text-base text-justify text-gray-500 font-poppins">
